...
@section('title', isset($stakeholder) ? 'Edit Stakeholder' : 'Create Stakeholder')
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4>{{ isset($stakeholder) ? 'Edit Stakeholder' : 'Create New Stakeholder' }}</h4>
                </div>
                <div class="card-body">
                    <form action="{{ isset($stakeholder) ? route('stakeholders.update', $stakeholder) : route('stakeholders.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary">
                                {{ isset($stakeholder) ? 'Update' : 'Create' }} Stakeholder
                            </button>
                        </div>
                    </form>
                </div>
